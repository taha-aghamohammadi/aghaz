...
function HowItWorks() {
  const steps = [
    { icon: BadgeCheck, title: "ثبت‌نام و احراز", desc: "کمتر از یک دقیقه حساب بساز، یه بار احراز هویت کن — برای همیشه معتبره." },
    { icon: Calendar, title: "رزرو و پرداخت", desc: "میز، تاریخ و ساعت رو انتخاب کن و آنلاین پرداخت کن." },
    { icon: DoorOpen, title: "ورود با درب هوشمند", desc: "درب رو از داشبوردت باز کن و سر میزت بشین — بدون کارت." },
    { icon: MonitorSmartphone, title: "شروع و تمدید", desc: "میزت آماده‌ست؛ زمان کم آوردی؟ با یک لمس تمدیدش کن." },
  ];
  return (
